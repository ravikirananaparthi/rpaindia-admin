...
const ViewActivities = () => {
  ...
  const handleActivityClick = (activity) => {
    navigate(`/admin/activity/${activity.id}`, { state: { activity } });
  };
        ...
        <div className="flex justify-between items-center p-1 ">
          ...
          <Link to={"/admin/activities/create"}>
            <button className="bg-sky-500 hover:bg-sky-700 text-white  py-2 px-3 rounded-lg flex items-center lg:mr-5">
              ...
              <span className="text-xs md:text-base">Create activity</span>
            </button>
          </Link>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {activities.map((activity) => (
            <ActivityCard
              ...
              onDelete={() => setSelectedActivity(activity)}
            />
          ))}
        </div>
        {activities.length === 0 && (
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          ...
                          <b>{selectedActivity.activityName}</b> <br />
